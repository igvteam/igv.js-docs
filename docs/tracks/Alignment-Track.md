...
| colorBy            | Alignment color option:  one of "none", "strand", "firstOfPairStrand", "pairOrientation", "tlen", "unexpectedPair", "tag",  or "tag:<tag name>".   To color by the YC tag specify "tag:YC". | "unexpectedPair".         | |                           |
